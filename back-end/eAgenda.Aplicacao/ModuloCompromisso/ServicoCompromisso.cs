...
namespace eAgenda.Aplicacao.ModuloCompromisso
{
    public class ServicoCompromisso : ServicoBase<Compromisso, ValidadorCompromisso>
    {
        ...
        public Result<List<Compromisso>> SelecionarTodos(Guid id)
        {
            Log.Logger.Debug("Tentando selecionar compromissos...");

            try
            {
                var compromissos = repositorioCompromisso.SelecionarTodos(id);
        ...
        public Result<List<Compromisso>> SelecionarCompromissosPassados(DateTime dataAtual)
        {
            return repositorioCompromisso.SelecionarCompromissosPassados(dataAtual);
        }
