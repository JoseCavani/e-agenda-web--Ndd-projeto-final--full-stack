    ...
    public class ServicoContato : ServicoBase<Contato, ValidadorContato>
    {
        ...
        public Result Excluir(Contato contato)
        {
            ...
            try
            {
                ...
                repositorioContato.Excluir(repositorioContato.SelecionarPorId(contato.Id));
        ...
        public Result Excluir(Guid id)
        {
            ...
            try
            {
                ...
                repositorioContato.Excluir(repositorioContato.SelecionarPorId(id));
        ...
        public Result<List<Contato>> SelecionarTodos(Guid id)
        {
            Log.Logger.Debug("Tentando selecionar contatos...");

            try
            {
                var contatos = repositorioContato.SelecionarTodos(id);
